...
%
%
\title{Evaluation of the UNESCO Institute for Statistics (UIS) RDF Data Sets}
\subtitle{}
...
\begin{abstract}
Evaluation of the UNESCO Institute for Statistics (UIS) RDF Data Sets
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://uis.270a.info/sparql} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \ding{55} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://uis.270a.info/sparql}}
    \label{tab:evaluation-uis.270a.info-sparql}
    \end{center}
\end{table}
...
\begin{table}[H]
    ...
    \\       \textbf{Data Sets}
           ...
           & \rot{\emph{DATA-MODEL-CONSISTENCY-11}}
	\\ \midrule
    \emph{EDULIT$\_$DS} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \ding{55} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \emph{SCN$\_$DS} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \ding{55} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \emph{DEMO$\_$DS} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \ding{55} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \emph{CUL$\_$DS} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \ding{55} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \emph{CAI$\_$DS} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \ding{55} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://uis.270a.info/sparql}} Data Sets
    \label{tab:evaluation-0-uis.270a.info-sparql}
    \end{center}
\end{table}
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://uis.270a.info/sparql} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://uis.270a.info/sparql}}
    \label{tab:evaluation-uis.270a.info-sparql}
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://uis.270a.info/sparql} & 118 & $\checkmark$ & $\checkmark$ & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://uis.270a.info/sparql}}
    \label{tab:evaluation-uis.270a.info-sparql}
...
\begin{table}[H]
    ...
    \\       \textbf{Data Sets}
           & \rot{\emph{MAXIMUM-QUALIFIED-CARDINALITY-RESTRICTIONS-01}}
	\\ \midrule
    \emph{EDULIT$\_$DS} & $\checkmark$  \\
    \emph{SCN$\_$DS} & $\checkmark$  \\
    \emph{DEMO$\_$DS} & $\checkmark$  \\
    \emph{CUL$\_$DS} & $\checkmark$  \\
    \emph{CAI$\_$DS} & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://uis.270a.info/sparql}} Data Sets
    \label{tab:evaluation-0-uis.270a.info-sparql}
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://uis.270a.info/sparql} & $\checkmark$ & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://uis.270a.info/sparql}}
    \label{tab:evaluation-uis.270a.info-sparql}
