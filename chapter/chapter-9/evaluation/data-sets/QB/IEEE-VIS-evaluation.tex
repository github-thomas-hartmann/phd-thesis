...
%
%
\title{Evaluation of IEEE VIS Source Data (IEEE-VIS) RDF Data Sets}
\subtitle{}
...
\begin{abstract}
Evaluation of IEEE VIS Source Data (IEEE-VIS) RDF Data Sets
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://ieeevis.tw.rpi.edu/sparql} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://ieeevis.tw.rpi.edu/sparql}}
    \label{tab:evaluation-ieeevis.tw.rpi.edu-sparql}
    \end{center}
\end{table}
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://ieeevis.tw.rpi.edu/sparql} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://ieeevis.tw.rpi.edu/sparql}}
    \label{tab:evaluation-ieeevis.tw.rpi.edu-sparql}
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://ieeevis.tw.rpi.edu/sparql} & 1350 & $\checkmark$ & $\checkmark$ & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://ieeevis.tw.rpi.edu/sparql}}
    \label{tab:evaluation-ieeevis.tw.rpi.edu-sparql}
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://ieeevis.tw.rpi.edu/sparql} & $\checkmark$ & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://ieeevis.tw.rpi.edu/sparql}}
    \label{tab:evaluation-ieeevis.tw.rpi.edu-sparql}
