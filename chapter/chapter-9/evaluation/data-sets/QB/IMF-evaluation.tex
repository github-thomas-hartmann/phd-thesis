...
%
%
\title{Evaluation of the International Monetary Fund (IMF) RDF Data Sets}
\subtitle{}
...
\begin{abstract}
Evaluation of the International Monetary Fund (IMF) RDF Data Sets
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://imf.270a.info/sparql} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \ding{55} & $\checkmark$ & 99091 & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://imf.270a.info/sparql}}
    \label{tab:evaluation-imf.270a.info-sparql}
    \end{center}
\end{table}
...
\begin{table}[H]
    ...
    \\       \textbf{Data Sets}
           ...
           & \rot{\emph{DATA-MODEL-CONSISTENCY-11}}
	\\ \midrule
    \emph{MBLD} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \ding{55} & $\checkmark$ & 98369 & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \emph{PGI} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \ding{55} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \emph{MCORE} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \ding{55} & $\checkmark$ & 722 & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \emph{DM} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \ding{55} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://imf.270a.info/sparql}} Data Sets
    \label{tab:evaluation-0-imf.270a.info-sparql}
    \end{center}
\end{table}
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://imf.270a.info/sparql} & 11 & $\checkmark$ & $\checkmark$ & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://imf.270a.info/sparql}}
    \label{tab:evaluation-imf.270a.info-sparql}
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://imf.270a.info/sparql} & 8 & $\checkmark$ & $\checkmark$ & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://imf.270a.info/sparql}}
    \label{tab:evaluation-imf.270a.info-sparql}
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://imf.270a.info/sparql} & $\checkmark$ & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://imf.270a.info/sparql}}
    \label{tab:evaluation-imf.270a.info-sparql}
