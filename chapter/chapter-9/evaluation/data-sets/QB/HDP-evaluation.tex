...
%
%
\title{Evaluation of HealthData.gov Platform (HDP) on the Semantic Web RDF Data Sets}
\subtitle{}
...
\begin{abstract}
Evaluation of HealthData.gov Platform (HDP) on the Semantic Web RDF Data Sets
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://healthdata.tw.rpi.edu/sparql} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://healthdata.tw.rpi.edu/sparql}}
    \label{tab:evaluation-healthdata.tw.rpi.edu-sparql}
    \end{center}
\end{table}
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://healthdata.tw.rpi.edu/sparql} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://healthdata.tw.rpi.edu/sparql}}
    \label{tab:evaluation-healthdata.tw.rpi.edu-sparql}
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://healthdata.tw.rpi.edu/sparql} & $\checkmark$ & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://healthdata.tw.rpi.edu/sparql}}
    \label{tab:evaluation-healthdata.tw.rpi.edu-sparql}
