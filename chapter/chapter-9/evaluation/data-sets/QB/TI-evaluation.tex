...
%
%
\title{Evaluation of Transparency International (TI) RDF Data Sets}
\subtitle{}
...
\begin{abstract}
Evaluation of Transparency International (TI) RDF Data Sets
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://transparency.270a.info/sparql} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://transparency.270a.info/sparql}}
    \label{tab:evaluation-transparency.270a.info-sparql}
    \end{center}
\end{table}
...
\begin{table}[H]
    ...
    \\       \textbf{Data Sets}
           ...
           & \rot{\emph{DATA-MODEL-CONSISTENCY-11}}
	\\ \midrule
    \emph{CPI2009} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \emph{CPI2010} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \emph{CPI2011} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \emph{corruption-perceptions-index/2009/sources} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \emph{corruption-perceptions-index/2010/sources} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \emph{corruption-perceptions-index/2011/sources} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://transparency.270a.info/sparql}} Data Sets
    \label{tab:evaluation-0-transparency.270a.info-sparql}
    \end{center}
\end{table}
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://transparency.270a.info/sparql} & 9 & $\checkmark$ & 6 & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://transparency.270a.info/sparql}}
    \label{tab:evaluation-transparency.270a.info-sparql}
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://transparency.270a.info/sparql} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://transparency.270a.info/sparql}}
    \label{tab:evaluation-transparency.270a.info-sparql}
...
\begin{table}[H]
    ...
    \\       \textbf{Data Sets}
           & \rot{\emph{MAXIMUM-QUALIFIED-CARDINALITY-RESTRICTIONS-01}}
	\\ \midrule
    \emph{CPI2009} & $\checkmark$  \\
    \emph{CPI2010} & $\checkmark$  \\
    \emph{CPI2011} & $\checkmark$  \\
    \emph{corruption-perceptions-index/2009/sources} & $\checkmark$  \\
    \emph{corruption-perceptions-index/2010/sources} & $\checkmark$  \\
    \emph{corruption-perceptions-index/2011/sources} & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://transparency.270a.info/sparql}} Data Sets
    \label{tab:evaluation-0-transparency.270a.info-sparql}
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://transparency.270a.info/sparql} & $\checkmark$ & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://transparency.270a.info/sparql}}
    \label{tab:evaluation-transparency.270a.info-sparql}
