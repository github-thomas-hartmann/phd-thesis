...
%
%
\title{Evaluation of the Bank for International Settlements (BIS) RDF Data Sets}
\subtitle{}
...
\begin{abstract}
Evaluation of the Bank for International Settlements (BIS) RDF Data Sets
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://bis.270a.info/sparql} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \ding{55} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://bis.270a.info/sparql}}
    \label{tab:evaluation-bis.270a.info-sparql}
    \end{center}
\end{table}
...
\begin{table}[H]
    ...
    \\       \textbf{Data Sets}
           ...
           & \rot{\emph{DATA-MODEL-CONSISTENCY-11}}
	\\ \midrule
    \emph{BIS$\_$M$\_$IBLR} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \ding{55} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \emph{BIS$\_$M$\_$CIBL$\_$IB} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \ding{55} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \emph{BIS$\_$M$\_$CIBL$\_$UR} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \ding{55} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \emph{BIS$\_$EER} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \ding{55} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \emph{BIS$\_$TOTAL$\_$CREDIT} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \ding{55} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \emph{BIS$\_$M$\_$IBLN} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \ding{55} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & - & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://bis.270a.info/sparql}} Data Sets
    \label{tab:evaluation-0-bis.270a.info-sparql}
    \end{center}
\end{table}
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://bis.270a.info/sparql} & 8 & $\checkmark$ & $\checkmark$ & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://bis.270a.info/sparql}}
    \label{tab:evaluation-bis.270a.info-sparql}
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://bis.270a.info/sparql} & 12 & $\checkmark$ & $\checkmark$ & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://bis.270a.info/sparql}}
    \label{tab:evaluation-bis.270a.info-sparql}
...
\begin{table}[H]
    ...
    \\       \textbf{Data Sets}
           & \rot{\emph{MAXIMUM-QUALIFIED-CARDINALITY-RESTRICTIONS-01}}
	\\ \midrule
    \emph{BIS$\_$M$\_$IBLR} & $\checkmark$  \\
    \emph{BIS$\_$M$\_$CIBL$\_$IB} & $\checkmark$  \\
    \emph{BIS$\_$M$\_$CIBL$\_$UR} & $\checkmark$  \\
    \emph{BIS$\_$EER} & $\checkmark$  \\
    \emph{BIS$\_$TOTAL$\_$CREDIT} & $\checkmark$  \\
    \emph{BIS$\_$M$\_$IBLN} & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://bis.270a.info/sparql}} Data Sets
    \label{tab:evaluation-0-bis.270a.info-sparql}
...
\begin{table}[H]
	...
	\\ \midrule
    \emph{http://bis.270a.info/sparql} & $\checkmark$ & $\checkmark$  \\
    \bottomrule
    \end{tabular}
    \caption{Evaluation of \emph{http://bis.270a.info/sparql}}
    \label{tab:evaluation-bis.270a.info-sparql}
