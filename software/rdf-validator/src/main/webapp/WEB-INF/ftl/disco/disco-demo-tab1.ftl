<form id="form-disco-demo-tab1" action="<@spring.url '/disco/demo/tab1' />" style="padding-left: 25px" class="MISSY_round_right" >	
	...
	<fieldset>
		<input 
		  type="button" 
		  name="button_disco-demo-tab1" 
		  id="button_disco-demo-tab1" 
