<form id="form-disco-tab1" action="<@spring.url '/disco/onegraph/tab1' />" style="padding-left: 25px" class="MISSY_round_right">
	...
	<fieldset>
		...
		<table>
	        <tr style="background:transparent">
	            <td style="width:50%">
	            	<input id="fileupload" style="width:100%;max-width:none" type="file" name="files[]" data-url="<@spring.url '/disco/upload' />" multiple />
				</td>
	            <td>
		...
		<table>
	        <tr style="background:transparent">
	            <td style="width:50%">
	            	...
	            	<input id="fileupload" style="width:60%;max-width:none" type="file" name="files[]" data-url="<@spring.url '/disco/multiple-file-upload' />" data-remove-url="<@spring.url '/owl2/deleteFile' />" multiple />
				</td>
				<td>
				    <#-- form onsite help -->
	...
	<#--<fieldset>
		<input 
		  type="button" 
		  name="button_disco-tab1" 
		  id="button_disco-tab1" 
		  value="Next: Validate" 
...
<script>
	$jQ(function() {
    	...
    	getUploadedDocument( "#accordion_result_area" , "<@spring.url '/disco/getuploaded' />" ,  "<@spring.url '/disco/deleteFile' />");
