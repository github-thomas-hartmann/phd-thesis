<form id="form-disco-demo-tab2" action="<@spring.url '/disco/demo/tab2' />" style="padding-left: 25px" class="MISSY_round_right" >	
...
<script>
	...
	$jQ(document).ready(function() {   
	    <#-- create the tree -->
	    createTree( "#dirInferenceRules", "disco","#containerInferenceRules", "/resources/rdfGraphs/DISCO/inferenceRules" );
	    <#-- show empty textarea -->
