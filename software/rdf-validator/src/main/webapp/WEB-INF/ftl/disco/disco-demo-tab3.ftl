<form style="padding-left: 25px"  id="form-disco-demo-tab3" action="<@spring.url '/disco/demo/tab3' />" class="MISSY_round_right">
...
<script>
	...
	$jQ(document).ready(function() {   
	    <#-- create the tree -->
	    createTree( "#dirData", "disco", "#containerData", "/resources/rdfGraphs/DISCO/data" );
	    <#-- show empty textarea -->
