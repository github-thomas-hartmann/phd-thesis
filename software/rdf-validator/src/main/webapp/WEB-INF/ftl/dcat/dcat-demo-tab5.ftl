<form id="form-dcat-demo-tab4" action="<@spring.url '/dcat/demo/tab4' />" style="padding-left: 25px" class="MISSY_round_right">

	<fieldset>
		<input 
		  type="button" 
		  name="button_dcat-demo-validation" 
		  id="button_dcat-demo-validation" 
		  value="Validate" 
