<form style="padding-left: 25px"  id="form-dcat-demo-tab3" action="<@spring.url '/dcat/demo/tab3' />" class="MISSY_round_right">
...
<script>
	...
	$jQ(document).ready(function() {   
	    <#-- create the tree -->
	    createTree( "#dirData", "dcat", "#containerData", "/resources/rdfGraphs/DCAT/data" );
	    <#-- show empty textarea -->
