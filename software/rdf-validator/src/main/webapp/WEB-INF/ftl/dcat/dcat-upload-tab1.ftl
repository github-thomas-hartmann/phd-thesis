<form id="form-dcat-tab1" action="<@spring.url '/dcat/onegraph/tab1' />" style="padding-left: 25px" class="MISSY_round_right">
	...
	<fieldset>
		...
		<table>
	        <tr style="background:transparent">
	            <td style="width:50%">
	            	<input id="fileupload" style="width:100%;max-width:none" type="file" name="files[]" data-url="<@spring.url '/dcat/upload' />" multiple />
				</td>
	            <td>
		...
		<table>
	        <tr style="background:transparent">
	            <td style="width:50%">
	            	...
	            	<input id="fileupload" style="width:60%;max-width:none" type="file" name="files[]" data-url="<@spring.url '/dcat/multiple-file-upload' />" data-remove-url="<@spring.url '/owl2/deleteFile' />" multiple />
				</td>
				<td>
				    <#-- form onsite help -->
...
<script>
	$jQ(function() {
    	...
    	getUploadedDocument( "#accordion_result_area" , "<@spring.url '/dcat/getuploaded' />" ,  "<@spring.url '/dcat/deleteFile' />");
