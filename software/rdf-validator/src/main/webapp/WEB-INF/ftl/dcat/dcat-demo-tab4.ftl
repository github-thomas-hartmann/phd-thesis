<form id="form-dcat-demo-tab2" action="<@spring.url '/dcat/demo/tab2' />" style="padding-left: 25px" class="MISSY_round_right" >	
...
<script>
	...
	$jQ(document).ready(function() {   
	    <#-- create the tree -->
	    createTree( "#dirInferenceRules", "dcat","#containerInferenceRules", "/resources/rdfGraphs/dcat/inferenceRules" );
	    <#-- show empty textarea -->
