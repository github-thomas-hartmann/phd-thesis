<form id="form-phdd-demo-tab2" action="<@spring.url '/phdd/demo/tab2' />" style="padding-left: 25px" class="MISSY_round_right" >	
...
<script>
	...
	$jQ(document).ready(function() {   
	    <#-- create the tree -->
	    createTree( "#dirInferenceRules", "phdd","#containerInferenceRules", "/resources/rdfGraphs/phdd/inferenceRules" );
	    <#-- show empty textarea -->
