<form id="form-phdd-demo-tab1" action="<@spring.url '/phdd/demo/tab1' />" style="padding-left: 25px" class="MISSY_round_right" >	
	...
	<fieldset>
		<input 
		  type="button" 
		  name="button_phdd-demo-tab1" 
		  id="button_phdd-demo-tab1" 
...
$jQ( function(){
	...
	getDocumentDetails( "<@spring.url '/phdd/file_details' />", "defaultNamespaceDeclarations.ttl", "#containerNamespaceDeclarations", "resources/rdfGraphs/PHDD/" );
