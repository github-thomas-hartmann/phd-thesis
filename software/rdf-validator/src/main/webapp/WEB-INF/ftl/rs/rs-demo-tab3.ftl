<form style="padding-left: 25px"  id="form-rs-demo-tab3" action="<@spring.url '/rs/demo/tab3' />" class="MISSY_round_right">
...
<script>
	...
	$jQ(document).ready(function() {   
	    <#-- create the tree -->
	    createTree( "#dirData", "rs", "#containerData", "/resources/rdfGraphs/RS/data" );
	    <#-- show empty textarea -->
