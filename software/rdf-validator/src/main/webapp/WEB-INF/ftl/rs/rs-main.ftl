 <@layout.global>
 	...
 	<@content.left>
			<div id="col1_content" class="clearfix">
				...
				<div id="rsTabContainer" class="tabContainer">
					<ul>
						<li>
							<a class="tabElement" href="#study_tab" style="text-decoration:none;">rs</a>
						</li>
					</ul>
...
<script>
	$jQ( function() // begin document ready
	{
		...
		$jQ( "#rsTabContainer" ).tabs({ active: 0 });
		$jQ( "#rsTabContainer" ).css( "margin-top", "66px");
		$jQ( "#rsTabContainer" ).css( "margin-left", "5px");
		$jQ( "#rsTabContainer" ).css( "margin-right", "5px");
