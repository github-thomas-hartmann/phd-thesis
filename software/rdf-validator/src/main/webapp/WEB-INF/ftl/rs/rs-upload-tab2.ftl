<form id="form-rs-tab5" action="<@spring.url '/rs/onegraph/tab5' />" style="padding-left: 25px" class="MISSY_round_right">

	<fieldset>
		<input 
		  type="button" 
		  name="button_rs-upload-validation" 
		  id="button_rs-upload-validation" 
		  value="Validate" 
		  class="buttonSubmit MISSY_loginSubmit" 
		  style="float: right; margin-top: 10px">
	</fieldset>
	
	<fieldset id="rs-validation-result">
		<#-- ajax content here -->
	</fieldset>

	
	<fieldset id="rs-validation-inputs">
