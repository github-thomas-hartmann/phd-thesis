<form id="form-xkos-demo-tab1" action="<@spring.url '/xkos/demo/tab1' />" style="padding-left: 25px" class="MISSY_round_right" >	
	<!--
	...
	<fieldset>
		<input 
		  type="button" 
		  name="button_xkos-demo-tab1" 
		  id="button_xkos-demo-tab1" 
