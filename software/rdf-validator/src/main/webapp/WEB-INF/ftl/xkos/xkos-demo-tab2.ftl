<form id="form-xkos-demo-tab2" action="<@spring.url '/xkos/demo/tab2' />" style="padding-left: 25px" class="MISSY_round_right" >	
...
<script>
	...
	$jQ(document).ready(function() {   
	    <#-- create the tree -->
	    createTree( "#dirConstraints", "xkos", "#containerConstraints", "/resources/rdfGraphs/XKOS/constraints and data" );
	    <#-- show empty textarea -->
