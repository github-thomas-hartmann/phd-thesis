<form id="form-xkos-demo-tab4" action="<@spring.url '/xkos/demo/tab4' />" style="padding-left: 25px" class="MISSY_round_right">

	<fieldset>
		<input 
		  type="button" 
		  name="button_xkos-demo-validation" 
		  id="button_xkos-demo-validation" 
		  value="Validate" 
