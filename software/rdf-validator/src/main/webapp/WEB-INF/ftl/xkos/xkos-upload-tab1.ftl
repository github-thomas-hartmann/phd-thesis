<form id="form-xkos-tab1" action="<@spring.url '/xkos/onegraph/tab1' />" style="padding-left: 25px" class="MISSY_round_right">
	...
	<fieldset>
		...
		<table>
	        <tr style="background:transparent">
	            <td style="width:50%">
	            	<input id="fileupload" style="width:100%;max-width:none" type="file" name="files[]" data-url="<@spring.url '/xkos/upload' />" multiple />
				</td>
	            <td>
		...
		<table>
	        <tr style="background:transparent">
	            <td style="width:50%">
	            	...
	            	<input id="fileupload" style="width:60%;max-width:none" type="file" name="files[]" data-url="<@spring.url '/xkos/multiple-file-upload' />" data-remove-url="<@spring.url '/owl2/deleteFile' />" multiple />
				</td>
				<td>
				    <#-- form onsite help -->
					<a href="#" class="MISSY_onsiteHelp" style="margin-top:6px;vertical-align:top;">
						...
						<span style="width:310px;">
						    ...
						    <ul style="margin: 0;">
						    	<li style="list-style-type: disc;">predefined namespace declarations: xsd, rdf, rdfs, owl, dcterms, xkos, foaf, dcam, dsp, swrc, : (default namespace)</li>
...
<script>
	$jQ(function() {
    	...
    	getUploadedDocument( "#accordion_result_area" , "<@spring.url '/xkos/getuploaded' />" ,  "<@spring.url '/xkos/deleteFile' />");
