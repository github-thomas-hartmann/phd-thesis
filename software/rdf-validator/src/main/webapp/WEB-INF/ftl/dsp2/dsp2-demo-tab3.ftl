<form style="padding-left: 25px"  id="form-dsp2-demo-tab3" action="<@spring.url '/dsp2/demo/tab3' />" class="MISSY_round_right">
...
<script>
	...
	$jQ(document).ready(function() {   
	    <#-- create the tree -->
	    createTree( "#dirData", "dsp", "#containerData", "/resources/rdfGraphs/dsp2/data" );
	    <#-- show empty textarea -->
