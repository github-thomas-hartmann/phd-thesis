<form id="form-dsp2-demo-tab1" action="<@spring.url '/dsp2/demo/tab1' />" style="padding-left: 25px" class="MISSY_round_right" >	
	...
	<fieldset>
		<input 
		  type="button" 
		  name="button_dsp2-demo-tab1" 
		  id="button_dsp2-demo-tab1" 
...
$jQ( function(){
	...
	getDocumentDetails( "<@spring.url '/dsp2/file_details' />", "defaultNamespaceDeclarations.ttl", "#containerNamespaceDeclarations", "resources/rdfGraphs/DSP2/" );
