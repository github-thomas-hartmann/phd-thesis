<form id="form-dsp2-demo-tab2" action="<@spring.url '/dsp2/demo/tab2' />" style="padding-left: 25px" class="MISSY_round_right" >	
...
<script>
	...
	$jQ(document).ready(function() {   
	    <#-- create the tree -->
	    createTree( "#dirInferenceRules", "dsp","#containerInferenceRules", "/resources/rdfGraphs/dsp2/inferenceRules" );
	    <#-- show empty textarea -->
