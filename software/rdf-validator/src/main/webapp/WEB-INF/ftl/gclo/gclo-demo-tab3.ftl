<form style="padding-left: 25px"  id="form-gclo-demo-tab3" action="<@spring.url '/gclo/demo/tab3' />" class="MISSY_round_right">
...
<script>
	...
	$jQ(document).ready(function() {   
	    <#-- create the tree -->
	    createTree( "#dirData", "gclo", "#containerData", "/resources/rdfGraphs/GCLO/data" );
	    <#-- show empty textarea -->
