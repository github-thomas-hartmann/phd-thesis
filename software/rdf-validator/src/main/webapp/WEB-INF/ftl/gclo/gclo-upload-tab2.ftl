<form id="form-gclo-tab5" action="<@spring.url '/gclo/onegraph/tab5' />" style="padding-left: 25px" class="MISSY_round_right">

	<fieldset>
		<input 
		  type="button" 
		  name="button_gclo-upload-validation" 
		  id="button_gclo-upload-validation" 
		  value="Validate" 
		  class="buttonSubmit MISSY_loginSubmit" 
		  style="float: right; margin-top: 10px">
	</fieldset>
	
	<fieldset id="gclo-validation-result">
		<#-- ajax content here -->
	</fieldset>

	
	<fieldset id="gclo-validation-inputs">
