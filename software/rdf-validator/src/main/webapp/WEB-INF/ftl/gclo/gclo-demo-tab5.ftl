<form id="form-gclo-demo-tab4" action="<@spring.url '/gclo/demo/tab4' />" style="padding-left: 25px" class="MISSY_round_right">

	<fieldset>
		<input 
		  type="button" 
		  name="button_gclo-demo-validation" 
		  id="button_gclo-demo-validation" 
		  value="Validate" 
