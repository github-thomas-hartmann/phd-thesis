<form id="form-gclo-demo-tab1" action="<@spring.url '/gclo/demo/tab1' />" style="padding-left: 25px" class="MISSY_round_right" >	
	...
	<fieldset>
		<input 
		  type="button" 
		  name="button_gclo-demo-tab1" 
		  id="button_gclo-demo-tab1" 
...
$jQ( function(){
	...
	getDocumentDetails( "<@spring.url '/gclo/file_details' />", "defaultNamespaceDeclarations.ttl", "#containerNamespaceDeclarations", "resources/rdfGraphs/GCLO/" );
