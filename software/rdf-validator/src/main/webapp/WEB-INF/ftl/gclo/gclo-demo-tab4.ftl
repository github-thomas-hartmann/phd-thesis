<form id="form-gclo-demo-tab2" action="<@spring.url '/gclo/demo/tab2' />" style="padding-left: 25px" class="MISSY_round_right" >	
...
<script>
	...
	$jQ(document).ready(function() {   
	    <#-- create the tree -->
	    createTree( "#dirInferenceRules", "gclo","#containerInferenceRules", "/resources/rdfGraphs/GCLO/inferenceRules" );
	    <#-- show empty textarea -->
