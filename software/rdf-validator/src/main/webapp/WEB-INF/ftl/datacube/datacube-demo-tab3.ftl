<form style="padding-left: 25px"  id="form-datacube-demo-tab3" action="<@spring.url '/datacube/demo/tab3' />" class="MISSY_round_right">
...
<script>
	...
	$jQ(document).ready(function() {   
	    <#-- create the tree -->
	    createTree( "#dirData", "datacube", "#containerData", "/resources/rdfGraphs/DATACUBE/data" );
	    <#-- show empty textarea -->
