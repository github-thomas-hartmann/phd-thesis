<form id="form-datacube-demo-tab1" action="<@spring.url '/datacube/demo/tab1' />" style="padding-left: 25px" class="MISSY_round_right" >	
	...
	<fieldset>
		<input 
		  type="button" 
		  name="button_datacube-demo-tab1" 
		  id="button_datacube-demo-tab1" 
...
$jQ( function(){
	...
	getDocumentDetails( "<@spring.url '/datacube/file_details' />", "defaultNamespaceDeclarations.ttl", "#containerNamespaceDeclarations", "resources/rdfGraphs/DATACUBE/" );
