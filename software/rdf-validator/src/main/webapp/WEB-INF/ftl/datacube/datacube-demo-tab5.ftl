<form id="form-datacube-demo-tab4" action="<@spring.url '/datacube/demo/tab4' />" style="padding-left: 25px" class="MISSY_round_right">

	<fieldset>
		<input 
		  type="button" 
		  name="button_datacube-demo-validation" 
		  id="button_datacube-demo-validation" 
		  value="Validate" 
