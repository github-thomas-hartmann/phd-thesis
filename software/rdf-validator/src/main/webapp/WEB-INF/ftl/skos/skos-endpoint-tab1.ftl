<form id="form-skos-tab1" action="<@spring.url '/skos/onegraph/tab1' />" style="padding-left: 25px" class="MISSY_round_right">
	...
	<script>
		$jQ( function(){
			$jQ( "#accordionskosTab1" ).accordion({
				collapsible:true,
				active: false,
				heightStyle:"content"
			});
	...
	<fieldset>
		...
		<div id="accordionskosTab1">
			...
			<div id="accordion_content2" style="border: 1pt solid #aca690;">
				...
				<!--
				<#if sparqlEndpoints??>
				    <select name="sparqlEndpoints" multiple style="margin-left: 20px; height:250px; max-height:1000px; width:550px; max-width: 1000px">
				    	<#list sparqlEndpoints as sparqlEndpoint>
