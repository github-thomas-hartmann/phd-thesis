<form id="form-skos-demo-tab1" action="<@spring.url '/skos/demo/tab1' />" style="padding-left: 25px" class="MISSY_round_right" >	
	...
	<fieldset>
		<input 
		  type="button" 
		  name="button_skos-demo-tab1" 
		  id="button_skos-demo-tab1" 
...
$jQ( function(){
	...
	getDocumentDetails( "<@spring.url '/skos/file_details' />", "defaultNamespaceDeclarations.ttl", "#containerNamespaceDeclarations", "resources/rdfGraphs/SKOS/" );
