<form id="form-skos-demo-tab2" action="<@spring.url '/skos/demo/tab2' />" style="padding-left: 25px" class="MISSY_round_right" >	
...
<script>
	...
	$jQ(document).ready(function() {   
	    <#-- create the tree -->
	    createTree( "#dirInferenceRules", "skos","#containerInferenceRules", "/resources/rdfGraphs/SKOS/inferenceRules" );
	    <#-- show empty textarea -->
