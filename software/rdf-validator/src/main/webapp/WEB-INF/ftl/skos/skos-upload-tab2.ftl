<form id="form-skos-tab5" action="<@spring.url '/skos/onegraph/tab5' />" style="padding-left: 25px" class="MISSY_round_right">

	<fieldset>
		<input 
		  type="button" 
		  name="button_skos-upload-validation" 
		  id="button_skos-upload-validation" 
		  value="Validate" 
	...
	<fieldset id="skos-validation-inputs">
