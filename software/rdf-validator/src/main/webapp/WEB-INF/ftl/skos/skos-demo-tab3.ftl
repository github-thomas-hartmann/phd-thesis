<form style="padding-left: 25px"  id="form-skos-demo-tab3" action="<@spring.url '/skos/demo/tab3' />" class="MISSY_round_right">
...
<script>
	...
	$jQ(document).ready(function() {   
	    <#-- create the tree -->
	    createTree( "#dirData", "skos", "#containerData", "/resources/rdfGraphs/SKOS/data" );
	    <#-- show empty textarea -->
