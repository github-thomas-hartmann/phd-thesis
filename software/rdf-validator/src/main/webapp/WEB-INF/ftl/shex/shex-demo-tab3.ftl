<form style="padding-left: 25px"  id="form-shex-demo-tab3" action="<@spring.url '/shex/demo/tab3' />" class="MISSY_round_right">
...
<script>
	...
	$jQ(document).ready(function() {   
	    <#-- create the tree -->
	    createTree( "#dirData", "shex", "#containerData", "/resources/rdfGraphs/ShEx/data" );
	    <#-- show empty textarea -->
