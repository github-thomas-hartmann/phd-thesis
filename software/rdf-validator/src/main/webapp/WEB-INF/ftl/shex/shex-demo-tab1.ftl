<form id="form-shex-demo-tab1" action="<@spring.url '/shex/demo/tab1' />" style="padding-left: 25px" class="MISSY_round_right" >	
	...
	<fieldset>
		<input 
		  type="button" 
		  name="button_shex-demo-tab1" 
		  id="button_shex-demo-tab1" 
...
$jQ( function(){
	...
	getDocumentDetails( "<@spring.url '/shex/file_details' />", "defaultNamespaceDeclarations.ttl", "#containerNamespaceDeclarations", "resources/rdfGraphs/ShEx/" );
