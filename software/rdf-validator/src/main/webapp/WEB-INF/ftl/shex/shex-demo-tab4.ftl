<form id="form-shex-demo-tab2" action="<@spring.url '/shex/demo/tab2' />" style="padding-left: 25px" class="MISSY_round_right" >	
...
<script>
	...
	$jQ(document).ready(function() {   
	    <#-- create the tree -->
	    createTree( "#dirInferenceRules", "shex","#containerInferenceRules", "/resources/rdfGraphs/ShEx/inferenceRules" );
	    <#-- show empty textarea -->
