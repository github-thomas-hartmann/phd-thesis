 	...
 	<@content.left>
			<div id="col1_content" class="clearfix">
				...
				<div id="graphTabContainer" class="tabContainer">
					<ul>
						<li>
							<a class="tabElement" href="#study_tab" style="text-decoration:none;">OWL2</a>
						</li>
					</ul>
...
<script>
	$jQ( function() // begin document ready
	{
		...
		$jQ( "#graphTabContainer" ).css( "margin-left", "5px");
		...
		$jQ(".graphButton").click( function(){
			...
			if( selectedNav != currentNavButton ){
				...
				$jQ.ajax( {
					type: "get",
					url:  "<@spring.url '/owl2/' />" + selectedNav
				    })
			    	.done( function( html ) {
