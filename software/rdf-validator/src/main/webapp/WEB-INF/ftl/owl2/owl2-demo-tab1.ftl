<form id="form-owl2-demo-tab1" action="<@spring.url '/owl2/demo/tab1' />" style="padding-left: 25px" class="MISSY_round_right" >	
	...
	<fieldset>
		<input 
		  type="button" 
		  name="button_owl-demo-tab1" 
		  id="button_owl2-demo-tab1" 
...
$jQ( function(){
	...
	getDocumentDetails( "<@spring.url '/owl2/file_details' />", "defaultNamespaceDeclarations.ttl", "#containerNamespaceDeclarations", "resources/rdfGraphs/OWL2/" );
