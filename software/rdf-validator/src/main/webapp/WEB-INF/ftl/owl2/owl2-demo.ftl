<h1>Demo</h1>
<!-- the tabs -->
<div id="owl2TabContainer" class="tabContainer">
	<ul style="height: 40px;">	
		<li><a class="tabElement" href="#owl2-demo-tab1" style="text-decoration:none;padding: 10px 15px;"><span>1.</span> Namespace Declarations</a></li>
	...
	<div id="owl2-demo-tab1" style="padding:0 !important; border:none; float:left; width:100%">
		<#include "owl2-demo-tab1.ftl" />
	</div>
	<div id="owl2-demo-tab2" style="padding:0 !important;border:none;float:left; width:100%">
		<#include "owl2-demo-tab2.ftl" />
	</div>
	<div id="owl2-demo-tab3" style="padding:0 !important;border:none;float:left; width:100%">
		<#include "owl2-demo-tab3.ftl" />
	</div>
	<div id="owl2-demo-tab4" style="padding:0 !important;border:none;float:left; width:100%">
		<#include "owl2-demo-tab4.ftl" />
	</div>
	<div id="owl2-demo-tab5" style="padding:0 !important;border:none;float:left; width:100%">
		<#include "owl2-demo-tab5.ftl" />
	</div>
...
<script>
	$jQ( function() // begin document ready
	{
		...
		$jQ( "#owl2TabContainer" ).tabs({ 
			active: 0
			<!-- disabled: [1,2,3] -->
     	});
     	
     	<#-- on last tab press - collect all inputs -->
     	$jQ( "#owl2-validation-tab" ).click( function(){
     	...
     	$jQ( "#button_owl2-demo-validation" ).click( function(){
     		<#-- validate the result -->
     		ajaxOwl2DemoValidation( "#owl2-validation-result" );
     	});
	...
	-->
	function ajaxOwl2DemoValidation( containerResult ){
		<#-- disable validate button -->
		$jQ('#button_owl2-demo-validation').attr("disabled",true).addClass("buttonSubmitDissabled");
		<#-- Add loading icon -->
		$jQ( containerResult )
			.html( "" )
		...
		$jQ.ajax( {
			type: "post",
			url: "<@spring.url '/owl2/demo/validation' />",
			data: {
	    	...
	    	.done( function( html ) {
				...
				$jQ('#button_owl2-demo-validation').attr("disabled",false).removeClass("buttonSubmitDissabled");
			})
	    	.fail( function() {})
	    	.always( function() {
