<form id="form-owl2-tab5" action="<@spring.url '/owl2/upload/tab5' />" style="padding-left: 25px" class="MISSY_round_right">

	<fieldset>
		<input 
		  type="button" 
		  name="button_owl2-upload-validation" 
		  id="button_owl2-upload-validation" 
		  value="Validate" 
	...
	<fieldset id="owl2-validation-inputs">
