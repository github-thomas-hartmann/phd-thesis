<form id="form-owl2-demo-tab2" action="<@spring.url '/owl2/demo/tab2' />" style="padding-left: 25px" class="MISSY_round_right" >	

	<fieldset>
		<#-- syntax direction -->
		<ul style="margin:0;width:90%">
	    	<li style="list-style-type: disc;">please enter your inference rules</li>
	    	<li style="list-style-type: disc;">inference rules are optional</li>
...
<script>
	...
	$jQ(document).ready(function() {   
	    <#-- create the tree -->
	    createTree( "#dirInferenceRules", "owl2","#containerInferenceRules", "/resources/rdfGraphs/OWL2/inferenceRules" );
	    <#-- show empty textarea -->
